...
#### FROM THE REPO: https://gitlab.com/uniluxembourg/snt/cvi2/space/spark-challenge/spark2024-utils/
...
# ... (assuming apply_threshold and folder paths are defined)

# Wrap the list with tqdm for a progress bar
for png_file in tqdm(png_files, desc="Processing images", unit="file"):
    ...
    # Note: Use 'RGBA' if your images have transparency, otherwise 'RGB'
    mode = 'RGB' if len(thresholded_channels) == 3 else 'RGBA'
    thresholded_image = Image.merge(mode, thresholded_channels)
